...
//        
        ...
        {
            Query<Person> query=QB.create(Person.class).addCondition(QB.eq(Person.Field.id,3));
    ...
    public void testJPQL() throws SQLException {
        ...
        LogUtil.show(db.getSqlTemplate(null).selectByJPQL(
                "select t.name,t.cell,pp.friendId,p2.name from person t,personFriends pp,person p2 where t.id=pp.pid and pp.friendId=p2.id", Var.class, null));
