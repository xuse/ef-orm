...
final class ManagedIConnection implements IConnection {
	protected final IConnection conn;
	private static Logger LOG = LoggerFactory.getLogger(ManagedIConnection.class);

	protected ManagedIConnection(IConnection conn) {
		this.conn = conn;
		try {
	...
	public void setAutoCommit(boolean b) throws SQLException {
		LOG.warn("Setting AutoCommit on: {}",this);
