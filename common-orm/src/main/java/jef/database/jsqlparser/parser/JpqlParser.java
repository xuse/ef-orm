/* Generated By:JavaCC: Do not edit this line. JpqlParser.java */
...
public class JpqlParser implements JpqlParserConstants {
    ...
    case K_FROM:
      ...
      case K_ORDER:
        orderBy = OrderByElements();
                                                                 plainSelect.setOrderBy(orderBy);
        break;
      default:
        jj_la1[38] = jj_gen;
        ;
  ...
  final public OrderBy OrderByElements() throws ParseException {
    ...
    orderByElement = OrderByElement();
                                                       orderBy=new OrderBy(); orderBy.add(orderByElement);
    label_15:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case 87:
  ...
  final public Expression PrimaryExpression() throws ParseException {
    ...
    default:
      ...
      if (jj_2_30(2147483647)) {
        ...
        token = jj_consume_token(S_INTEGER);
                                                                                                                   retval = new LongValue(token.image,integerReverse);
      } else if (jj_2_33(2)) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case 103:
        case 104:
  ...
  final public JpqlParameter sqlSegment() throws ParseException {
        Token name=null;
        Token type=null;
  ...
  final public JpqlParameter CaseJPQLParameter() throws ParseException {
    ...
    case 112:
      ...
      case S_IDENTIFIER:
        ...
        break;
      case K_START:
        name = jj_consume_token(K_START);
        break;
      case K_OVER:
        name = jj_consume_token(K_OVER);
        break;
      case K_LAST:
        name = jj_consume_token(K_LAST);
        break;
      case K_WITH:
