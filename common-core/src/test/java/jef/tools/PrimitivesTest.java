...
public class PrimitivesTest {
	...
	public void testTypes() {
		assertThat(Primitives.toWrapperClass(int.class), equalTo(Integer.class));
		assertThat(Primitives.toWrapperClass(short.class), equalTo(Short.class));
		assertThat(Primitives.toWrapperClass(long.class), equalTo(Long.class));
		assertThat(Primitives.toWrapperClass(double.class), equalTo(Double.class));
		assertThat(Primitives.toWrapperClass(float.class), equalTo(Float.class));
		assertThat(Primitives.toWrapperClass(char.class), equalTo(Character.class));
		assertThat(Primitives.toWrapperClass(boolean.class), equalTo(Boolean.class));
		assertThat(Primitives.toWrapperClass(byte.class), equalTo(Byte.class));
		
		
		assertThat(toWrapperClass0(int.class), equalTo(Integer.class));
		assertThat(toWrapperClass0(short.class), equalTo(Short.class));
		assertThat(toWrapperClass0(long.class), equalTo(Long.class));
		assertThat(toWrapperClass0(double.class), equalTo(Double.class));
		assertThat(toWrapperClass0(float.class), equalTo(Float.class));
		assertThat(toWrapperClass0(char.class), equalTo(Character.class));
		assertThat(toWrapperClass0(boolean.class), equalTo(Boolean.class));
		assertThat(toWrapperClass0(byte.class), equalTo(Byte.class));
	}
