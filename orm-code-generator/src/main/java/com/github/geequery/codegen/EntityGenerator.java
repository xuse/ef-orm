...
public class EntityGenerator {
	...
	public JavaUnit generateSource(String tablename, String entityName, String tableComment) throws SQLException {
		...
		for (Column c : meta.getColumns()) {
			generateColumn(pkColumns, c, tablename, java, enumField, pkFields);
		}
	...
	private void generateColumn(final Map<String, String> pkColumns, final Column c, final String tablename, final JavaUnit java, final JavaContainer enumField, final List<JavaField> pkFields) {
