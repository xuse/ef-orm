...
public class FindPassword extends DataObject{
	...
	@Column(name="isUsed",columnDefinition="boolean default '0'")
   ...
   public enum Field implements jef.database.Field{id,email,isused,createtime}
}