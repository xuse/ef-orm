...
public interface GqRepository<T, ID extends Serializable> extends PagingAndSortingRepository<T, ID>, QueryByExampleExecutor<T> {
	 ...
	 * @return
	 */
	<X extends IQueryableEntity> Page<X> find(jef.database.query.Query<X> data, Pageable page);
	 ...
	 * @return
	 */
	<X extends IQueryableEntity> List<X> find(jef.database.query.Query<X> data, Sort sort);
